...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSessionDidBeginInterruption", Selector = "audioSessionDidBeginInterruption:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSessionDidEndInterruption", Selector = "audioSessionDidEndInterruption:shouldResumeSession:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession), typeof (bool) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSessionDidChangeRoute", Selector = "audioSessionDidChangeRoute:reason:previousRoute:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession), typeof (AVAudioSessionRouteChangeReason), typeof (AVAudioSessionRouteDescription) }, ParameterByRef = new bool [] { false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSessionMediaServerTerminated", Selector = "audioSessionMediaServerTerminated:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSessionMediaServerReset", Selector = "audioSessionMediaServerReset:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSession", Selector = "audioSession:didChangeCanPlayOrRecord:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession), typeof (bool) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSessionDidStartPlayOrRecord", Selector = "audioSessionDidStartPlayOrRecord:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSessionDidStopPlayOrRecord", Selector = "audioSessionDidStopPlayOrRecord:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSession", Selector = "audioSession:didChangeOutputVolume:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession), typeof (float) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "AudioSession", Selector = "audioSession:didDetectPlayoutGlitch:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession), typeof (long) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "WillSetActive", Selector = "audioSession:willSetActive:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession), typeof (bool) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidSetActive", Selector = "audioSession:didSetActive:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession), typeof (bool) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "FailedToSetActive", Selector = "audioSession:failedToSetActive:error:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCAudioSession), typeof (bool), typeof (NSError) }, ParameterByRef = new bool [] { false, false, false })]
