...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidChangeSignalingState", Selector = "peerConnection:didChangeSignalingState:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCSignalingState) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidAddStream", Selector = "peerConnection:didAddStream:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCMediaStream) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidRemoveStream", Selector = "peerConnection:didRemoveStream:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCMediaStream) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "PeerConnectionShouldNegotiate", Selector = "peerConnectionShouldNegotiate:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidChangeIceConnectionState", Selector = "peerConnection:didChangeIceConnectionState:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCIceConnectionState) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidChangeIceGatheringState", Selector = "peerConnection:didChangeIceGatheringState:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCIceGatheringState) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidGenerateIceCandidate", Selector = "peerConnection:didGenerateIceCandidate:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCIceCandidate) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidRemoveIceCandidates", Selector = "peerConnection:didRemoveIceCandidates:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCIceCandidate[]) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidOpenDataChannel", Selector = "peerConnection:didOpenDataChannel:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCDataChannel) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidChangeStandardizedIceConnectionState", Selector = "peerConnection:didChangeStandardizedIceConnectionState:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCIceConnectionState) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidChangeConnectionState", Selector = "peerConnection:didChangeConnectionState:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.RTCPeerConnectionState) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidStartReceivingOnTransceiver", Selector = "peerConnection:didStartReceivingOnTransceiver:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.IRTCRtpTransceiver) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidAddReceiver", Selector = "peerConnection:didAddReceiver:streams:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.IRTCRtpReceiver), typeof (WebRTC.iOS.Binding.RTCMediaStream[]) }, ParameterByRef = new bool [] { false, false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidRemoveReceiver", Selector = "peerConnection:didRemoveReceiver:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCPeerConnection), typeof (WebRTC.iOS.Binding.IRTCRtpReceiver) }, ParameterByRef = new bool [] { false, false })]
