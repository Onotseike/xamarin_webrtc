...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "Capturer", Selector = "capturer:didCaptureVideoFrame:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCVideoCapturer), typeof (WebRTC.iOS.Binding.RTCVideoFrame) }, ParameterByRef = new bool [] { false, false })]
