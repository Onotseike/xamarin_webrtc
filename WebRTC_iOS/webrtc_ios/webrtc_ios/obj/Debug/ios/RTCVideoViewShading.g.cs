...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "Height", Selector = "applyShadingForFrameWithWidth:height:rotation:yPlane:uPlane:vPlane:", ParameterType = new Type [] { typeof (int), typeof (int), typeof (WebRTC.iOS.Binding.RTCVideoRotation), typeof (uint), typeof (uint), typeof (uint) }, ParameterByRef = new bool [] { false, false, false, false, false, false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "Height", Selector = "applyShadingForFrameWithWidth:height:rotation:yPlane:uvPlane:", ParameterType = new Type [] { typeof (int), typeof (int), typeof (WebRTC.iOS.Binding.RTCVideoRotation), typeof (uint), typeof (uint) }, ParameterByRef = new bool [] { false, false, false, false, false })]
