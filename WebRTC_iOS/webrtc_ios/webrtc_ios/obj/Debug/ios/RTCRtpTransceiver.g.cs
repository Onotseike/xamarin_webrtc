...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "MediaType", Selector = "mediaType", PropertyType = typeof (WebRTC.iOS.Binding.RTCRtpMediaType), GetterSelector = "mediaType", ArgumentSemantic = ArgumentSemantic.None)]
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "Sender", Selector = "sender", PropertyType = typeof (WebRTC.iOS.Binding.RTCRtpSender), GetterSelector = "sender", ArgumentSemantic = ArgumentSemantic.None)]
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "Receiver", Selector = "receiver", PropertyType = typeof (WebRTC.iOS.Binding.IRTCRtpReceiver), GetterSelector = "receiver", ArgumentSemantic = ArgumentSemantic.None)]
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "Direction", Selector = "direction", PropertyType = typeof (WebRTC.iOS.Binding.RTCRtpTransceiverDirection), GetterSelector = "direction", SetterSelector = "setDirection:", ArgumentSemantic = ArgumentSemantic.UnsafeUnretained)]
