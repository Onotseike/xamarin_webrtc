...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "Parameters", Selector = "parameters", PropertyType = typeof (WebRTC.iOS.Binding.RTCRtpParameters), GetterSelector = "parameters", SetterSelector = "setParameters:", ArgumentSemantic = ArgumentSemantic.Copy)]
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "Track", Selector = "track", PropertyType = typeof (WebRTC.iOS.Binding.RTCMediaStreamTrack), GetterSelector = "track", SetterSelector = "setTrack:", ArgumentSemantic = ArgumentSemantic.Copy)]
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "DtmfSender", Selector = "dtmfSender", PropertyType = typeof (WebRTC.iOS.Binding.RTCDtmfSender), GetterSelector = "dtmfSender", ArgumentSemantic = ArgumentSemantic.None)]
