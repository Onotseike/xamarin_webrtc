...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DataChannelDidChangeState", Selector = "dataChannelDidChangeState:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCDataChannel) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidReceiveMessageWithBuffer", Selector = "dataChannel:didReceiveMessageWithBuffer:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCDataChannel), typeof (WebRTC.iOS.Binding.RTCDataBuffer) }, ParameterByRef = new bool [] { false, false })]
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidChangeBufferedAmount", Selector = "dataChannel:didChangeBufferedAmount:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCDataChannel), typeof (ulong) }, ParameterByRef = new bool [] { false, false })]
	...
	public static partial class RTCDataChannelDelegate_Extensions {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void DidChangeBufferedAmount (this IRTCDataChannelDelegate This, RTCDataChannel dataChannel, ulong amount)
		{
			if (dataChannel == null)
...
namespace WebRTC.iOS.Binding {
	...
	public unsafe abstract partial class RTCDataChannelDelegate : NSObject, IRTCDataChannelDelegate {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual void DidChangeBufferedAmount (RTCDataChannel dataChannel, ulong amount)
		{
		...
		[Export ("dataChannel:didReceiveMessageWithBuffer:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public abstract void DidReceiveMessageWithBuffer (RTCDataChannel dataChannel, RTCDataBuffer buffer);
