...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "DidChangeVideoSize", Selector = "videoView:didChangeVideoSize:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.IRTCVideoRenderer), typeof (CGSize) }, ParameterByRef = new bool [] { false, false })]
