...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "CreateEncoder", Selector = "createEncoder:", ReturnType = typeof (WebRTC.iOS.Binding.RTCVideoEncoder), ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCVideoCodecInfo) }, ParameterByRef = new bool [] { false })]
	[ProtocolMember (IsRequired = false, IsProperty = true, IsStatic = false, Name = "SupportedCodecs", Selector = "supportedCodecs", PropertyType = typeof (WebRTC.iOS.Binding.RTCVideoCodecInfo[]), GetterSelector = "supportedCodecs", ArgumentSemantic = ArgumentSemantic.None)]
