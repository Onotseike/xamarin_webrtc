...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "DidReceiveFirstPacketForMediaType", Selector = "rtpReceiver:didReceiveFirstPacketForMediaType:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCRtpReceiver), typeof (WebRTC.iOS.Binding.RTCRtpMediaType) }, ParameterByRef = new bool [] { false, false })]
