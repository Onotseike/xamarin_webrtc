...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = false, IsStatic = false, Name = "RenderFrame", Selector = "renderFrame:", ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCVideoFrame) }, ParameterByRef = new bool [] { false })]
