...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = false, IsProperty = false, IsStatic = false, Name = "CreateDecoder", Selector = "createDecoder:", ReturnType = typeof (WebRTC.iOS.Binding.RTCVideoDecoder), ParameterType = new Type [] { typeof (WebRTC.iOS.Binding.RTCVideoCodecInfo) }, ParameterByRef = new bool [] { false })]
