...
namespace WebRTC.iOS.Binding {
	...
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "Parameters", Selector = "parameters", PropertyType = typeof (WebRTC.iOS.Binding.RTCRtpParameters), GetterSelector = "parameters", ArgumentSemantic = ArgumentSemantic.None)]
	[ProtocolMember (IsRequired = true, IsProperty = true, IsStatic = false, Name = "Track", Selector = "track", PropertyType = typeof (WebRTC.iOS.Binding.RTCMediaStreamTrack), GetterSelector = "track", ArgumentSemantic = ArgumentSemantic.None)]
